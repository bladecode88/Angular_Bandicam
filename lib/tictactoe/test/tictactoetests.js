var injector, TicTacToeService;

var init = {
    setup: function () {
        angular.module("TicTacToe");
        injector = angular.injector(['ng', 'TicTacToe']);
        TicTacToeService = injector.get('TicTacToeService');
    }
};

module("TicTacToeService Test", init);

QUnit.test("GivenANewGame_WhenTheGameStarts_ThenPlayer1CharacterIsX", function (assert) {
    var game = TicTacToeService.makeNewGame();
